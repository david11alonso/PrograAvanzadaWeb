...
{
    public partial class PropuestasDBContext : DbContext
    {
        public PropuestasDBContext()
        {
        }

        public PropuestasDBContext(DbContextOptions<PropuestasDBContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=localhost;Database=PropuestasDB;Trusted_Connection=True;");
            }
        }
